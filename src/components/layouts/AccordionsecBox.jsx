...
const AccordionsecBox = () => {
   ...
   return (
      <>
         <div className='pt-5'>
            <p className='text-lg text-white font-Inter font-normal paraShadows'>{data && data.naloxPara1[`${trans}`]}</p>
            ...
            <div className="flex flex-col lg:flex-row items-center gap-0 lg:gap-8 xl:gap-12 pb-6 -mt-2">
               ...
               <div>
                  ...
                  <p className='text-lg -mt-3 text-white text-center font-Inter font-normal paraShadows'>{data && data.naloxPara2[`${trans}`]}</p>
               </div>
               <div>
                  <img src={insert} alt="" className='mx-auto' />
                  <p className='text-lg -mt-8 text-white text-center font-Inter font-normal paraShadows'>{data && data.naloxPara3[`${trans}`]}</p>
               </div>
               <div>
                  <img src={clock} alt="" className='mx-auto' />
                  <p className='text-lg -mt-8 text-white text-center font-Inter font-normal paraShadows'>{data && data.naloxPara4[`${trans}`]}</p>
               </div>
