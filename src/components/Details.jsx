...
const Details = () => {
  ...
  return (
    ...
    <div className="pt-14 md:pt-24 w-[335px] sm:w-[500px] md:w-[650px] lg:w-[1000px] xl:w-[1150px] mx-auto">
      ...
      <div className='lg:justify-between md:justify-center flex flex-wrap gap-10 lg:gap-[120px] mx-auto items-start md:item-center py-0 md:py-10 lg:w-[1000px] xl:w-[1150px] md:w-[650px]'>

        <div className="card xl:w-[510px] lg:w-[440px] md:w-[650px] gap-5 flex flex-col">
        ...
        <div className="w-full mx-auto hidden lg:block xl:w-[1140px] ">
          <div className="heading">
            <h2 className='text-5xl font-Rajdhani font-semibold tracking-[4.8px] drop-shadow-5xl text-white m-auto text-center mb-10'>{data && data.detailssecTitle[`${trans}`]}</h2>
          </div>
          <Carousel />
        </div>
      </div>
