...
const Details = () => {
  ...
  return (
    ...
    <div className="pt-14 md:pt-24 w-[335px] sm:w-[500px] md:w-full mx-auto">
      ...
      <div className='lg:justify-between md:justify-center flex flex-wrap gap-28 mx-auto items-start md:item-center py-0 md:py-10 lg:w-[1020px] xl:w-[1150px] md:w-[770px]'>

        <div className="card xl:w-[500px] lg:w-[450px] md:w-[500px] gap-5 flex flex-col">
