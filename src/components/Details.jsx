...
const Details = () => {
  ...
  return (
    ...
    <div className="pt-14 md:pt-24 w-[335px] sm:w-[500px] md:w-[650px] lg:w-[1000px] xl:w-[1150px] mx-auto">
      ...
      <h2 className='md:text-5xl text-[28px] font-Rajdhani font-semibold tracking-[4.8px] drop-shadow-5xl text-white m-auto text-center pt-10'>{data && data.detailsPageTitle[`${trans}`]}</h2>
