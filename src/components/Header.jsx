    ...
    <div className=" w-full heroSec bg-cover bg-no-repeat bg-center ">
      <div className=' h-screen justify-center flex items-center py-24 lg:pt-10 mx-auto'>
        ...
        <div className='text-center z-10 pt-2'>
          ...
          <div className="w-[200px] mx-auto pt-4 md:pt-3 sm:pt-6 relative ">
            <div className='seeDetailsShadow w-full h-[70px] absolute top-0'></div>
            <a href="#details" className="text-lg seeDetailsShadows flex flex-col text-[#97E4FC] hover:text-[#C9F2FF] font-normal font-Inter cursor-pointer">{data && data.headerBtn[`${trans}`]} <img src={arrow} alt='arrow' className="w-auto duration-[10s] transition-all pt-6 animate-bounce m-auto" /> </a>
          </div>
        </div>
      </div>
    </div>
